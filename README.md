...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/yourlink
```

A live public deployment of this template is available at [https://yourlink.templates.workers.dev](https://yourlink.templates.workers.dev)
